...
class MonodepthModel(object):
    ...
    def image_resize_custom(self, net, kernel_size, stride):
    ...
    def build_test_vvvr(self):
        print("building the model")
        h0 = self.lrelu(self.conv2d(self.left, self.df_dim, name='d_h0_conv'))
    ...
    def build_model(self):
        with slim.arg_scope([slim.conv2d, slim.conv2d_transpose], activation_fn=tf.nn.elu):
                ...
                if self.params.encoder == 'vgg':
                    ...
                    self.build_resnet50()
                elif self.params.encoder == "testm8":
                    self.build_test_vvvr()


    def build_outputs(self):
        # print ("no output for now")
        # STORE DISPARITIES
    ...
    def build_losses(self):
        with tf.variable_scope('losses', reuse=self.reuse_variables):
            ...
            # self.discriminator_total_loss = 12.0
